{{-- View: C:/xampp/htdocs/nilak/resources/views/themes/default/layouts/master.blade.php --}}
<!DOCTYPE html>
...
<header class="site-header bg-white shadow-sm">
    <div class="container">
        <nav class="navbar navbar-light py-2 top-nav">
            <button id="mobileMenuToggle" class="mobile-hamburger d-md-none me-2" type="button">
        ...
        <nav class="navbar navbar-light border-top py-1">
...
<nav class="mobile-bottom-nav d-flex justify-content-around py-2">
    <a class="d-flex flex-column align-items-center" href="{{ route('home') }}">
        <svg viewBox="0 0 24 24"><path d="M3 11l9-7 9 7"/><path d="M5 10v10h14V10"/></svg>
        <span>خانه</span>
    </a>
    <a class="d-flex flex-column align-items-center" href="{{ route('shop.index') }}">
        <svg viewBox="0 0 24 24"><circle cx="9" cy="20" r="1"/><circle cx="18" cy="20" r="1"/><path d="M3 4h2l2.4 10.2a1 1 0 0 0 1 .8h9.7a1 1 0 0 0 1-.8L21 7H7"/></svg>
        <span>فروشگاه</span>
    </a>
    <a class="d-flex flex-column align-items-center" href="{{ route('cart.index') }}">
